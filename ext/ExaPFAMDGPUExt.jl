...
LS.DirectSolver(A::ROCSparseMatrixCSR; nblocks::Int=1) = error("No direct linear solver implemented for AMD GPUs yet.")
...
LS.default_linear_solver(A::ROCSparseMatrixCSR; nblocks::Int=1) = ExaPF.LS.Bicgstab(A; P=KP.kp_ilu0(A), ldiv=true)
