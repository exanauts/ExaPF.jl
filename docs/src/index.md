...
leverage the packages [`CUDA.jl`](https://github.com/JuliaGPU/CUDA.jl), [`CUDSS.jl`](https://github.com/exanauts/CUDSS.jl), [`AMDGPU.jl`](https://github.com/JuliaGPU/AMDGPU.jl), and
